...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textBrowser.setGeometry(QtCore.QRect(10, 430, 301, 421))
        self.textBrowser.setObjectName("textBrowser")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(0, 360, 311, 61))
        self.groupBox_4.setTitle("")
        self.groupBox_4.setObjectName("groupBox_4")
        self.pushButton_1 = QtWidgets.QPushButton(self.groupBox_4)
        self.pushButton_1.setGeometry(QtCore.QRect(10, 10, 141, 41))
        self.pushButton_1.setObjectName("pushButton_1")
        self.pushButton_2 = QtWidgets.QPushButton(self.groupBox_4)
        self.pushButton_2.setGeometry(QtCore.QRect(170, 10, 131, 41))
        ...
        self.groupBox.setGeometry(QtCore.QRect(190, 230, 120, 61))
        self.groupBox.setObjectName("groupBox")
        self.comboBox_other = QtWidgets.QComboBox(self.groupBox)
        self.comboBox_other.setGeometry(QtCore.QRect(10, 20, 101, 22))
        ...
        self.comboBox_other.addItem("")
        self.comboBox_other.addItem("")
        self.lineEdit_buyyu = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_buyyu.setGeometry(QtCore.QRect(260, 300, 41, 21))
        self.lineEdit_buyyu.setMaxLength(2)
        self.lineEdit_buyyu.setObjectName("lineEdit_buyyu")
        self.lineEdit_buyyan = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_buyyan.setGeometry(QtCore.QRect(260, 330, 41, 20))
        self.lineEdit_buyyan.setMaxLength(2)
        self.lineEdit_buyyan.setObjectName("lineEdit_buyyan")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(190, 300, 61, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(190, 326, 71, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "打手放清明左手边"))
        ...
        self.comboBox_other.setItemText(0, _translate("MainWindow", "御灵"))
        self.comboBox_other.setItemText(1, _translate("MainWindow", "抽N卡"))
        self.comboBox_other.setItemText(2, _translate("MainWindow", "砸百鬼"))
        self.comboBox_other.setItemText(3, _translate("MainWindow", "逢魔"))
        self.comboBox_other.setItemText(4, _translate("MainWindow", "狗粮升星"))
        self.comboBox_other.setItemText(5, _translate("MainWindow", "日轮刷玉"))
        self.comboBox_other.setItemText(6, _translate("MainWindow", "日轮刷层"))
        self.lineEdit_buyyu.setText(_translate("MainWindow", "0"))
        self.lineEdit_buyyan.setText(_translate("MainWindow", "0"))
        self.label_2.setText(_translate("MainWindow", "买溯玉次数"))
        self.label_3.setText(_translate("MainWindow", "买轮回眼次数"))
